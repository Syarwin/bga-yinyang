...
/*
 * YinYanglayerManager: all utility functions concerning players
 */

require_once('YinYangPlayer.class.php');

class YinYangPlayerManager extends APP_GameClass
{
  public $game;
  ...
  public function getPlayers($playerIds = null)
  {
    ...
    $players = [];
    foreach ($rows as $row) {
      $player = new YinYangPlayer($this->game, $row);
      $players[] = $player;
    }
    return $players;
  }
